...
const HistoireDatas = () => {
    ...
    <h2>Parcours Pro</h2>
    <div className="separator"></div>
    <div className="ParagHistoire">J&apos;ai ensuite trouvé mon premier emploi dans un bar-tabac-brasserie réputé de Lille dans lequel j&apos;ai commencé en tant qu&apos;employé polyvalent. Au fûr et à mesure des années j&apos;ai gagné en expérience et j&apos;ai fini par devenir directeur de l&apos;établissement. Avec les responsabilités qui vont avec (Gestion d&apos;équipe, recrutement, négociation fournisseurs, gestion de la carte...). Cette expérience a été l&apos;occasion de mettre en pratiques ce que j&apos;avais appris mais également de me confronter à de nombreux défis intéressants (Gestion d&apos;évenements comme la braderie de Lille, évolution de l&apos;entreprise et de son offre en fonction du marché...).</div>
    <div className="separator"></div>
    <h2>Raisons de la reconversion</h2>
    <div className="separator"></div>
    <div className="ParagHistoire">C&apos;est durant cette expérience que je me suis rendu compte de mon envie pour cette reconversion et ce style de métier. En effet, durant la période du COVID et le premier confinement en 2020, j&apos;avais anticipé le besoin d&apos;une carte dématérialisée, et donc de la mise en place d&apos;un site internet pour l&apos;entreprise. Comme les finances étaient délicates à gérer je me suis lancé dans le développement du site en autodidacte. Je me suis donc mis à apprendre l&apos;HTML et le CSS dans un premier temps pour donner l&apos;accés à la carte pour tout client. Puis dans la volonté de nous adapter j&apos;ai appris des bases de Javascript pour permettre la mise en ligne d&apos;une possibilité de click and collect ainsi que d&apos;une page de réservation pour la brasserie. et ces services ont réellement bien fonctionné. J&apos;ai alors eu le contact pour un site d&apos;hôtel qui devait permettre les réservations en ligne. Ces sites étaient très basiques mais je me suis rendu compte de mon attrait pour ce monde, je voulais alors apprendre pour développer des sites plus importants et mieux travaillés. Suite à la revente de la brasserie (Retraite du gérant), je n&apos;ai pas souhaité continuer l&apos;expérience pour enfin me tourner vers ce qui me paraissait être la suite logique et donc cette formation OpenClassRoom.</div>
        </div>
    )
}
